    ...
    <section id="portfolio">
      ...
      <fieldset>
		...
		$endereco = $rua . "," . $numero . "," . $bairro . "," . $cidade . "," . $estado;
				...
				$usu = $_SESSION['email'];
		        $selecao2 = "select p.cd_cpf_prestador, nm_prestador, nm_email,nr_telefone,ds_curriculo,nm_profissao,nm_rua,nr_casa,nm_bairro,nm_cidade,nm_estado from estado as e,cidade as c,bairro as b,logradouro as l,profissao as pro,prest_profi as pp,prestador as p
		...
		$enderecous = $row2["nm_rua"] . ", " . $row2["nr_casa"] . ", " . $row2["nm_bairro"] . ", " . $row2["nm_cidade"] . ", " .$row2["nm_estado"];
